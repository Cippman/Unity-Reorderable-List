...
namespace CippSharpEditor.Reorderable
{
    ...
    public class ReorderableUnityEventDrawer1 : PropertyDrawer
    {
        ...
        private static UnityEventBaseReferencesListHolder listHolder = ScriptableObject.CreateInstance<UnityEventBaseReferencesListHolder>();
...
//        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            listHolder.references = referenceses;
            SerializedObject serializedListHolder = new SerializedObject(listHolder);
            ...
            ReorderableList referencesReorderableList = new ReorderableList(references);
